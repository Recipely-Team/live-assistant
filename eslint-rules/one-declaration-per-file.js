...
/**
 * Enforces the standard "one declaration per file": at most one top-level
 * class, interface, type alias, or enum per .ts/.tsx file.
 *
 * Exceptions, mirroring the standard as written in CONTRIBUTING.md:
